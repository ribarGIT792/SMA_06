...
% Greiciausio nusileidimo metodas su Briodeno aproksimacija Jakobio
% matricai
...
for iii=1:itmax  % ciklas nusileidimo paieskos krypciu keitimui 
    ...
    if xp == x, 'nepavyksta pakeisti nusileidimo krypties'  % gali buti lokalus minimumas 
        fprintf(1,'\n paskutinis artinys x ='); fprintf(1,'  %g',x); plot3(x(1),x(2),0,'mp'); break
    end
    A=df_Broiden(xp,x,A);
end
